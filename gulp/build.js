...
gulp.task('html', ['inject', 'partials'], function () {
  ...
  var htmlFilter = $.filter(['*.html', '!/src/app/elements/br/*.html'], {restore: true});
...
gulp.task('brjs', function () {
  return gulp.src('src/**/br/*.{js,scss}')
    .pipe(gulp.dest(paths.dist + '/'))
    .pipe($.size());
});
...
gulp.task('buildapp', ['html', 'images', 'fonts', 'misc', 'data', 'brjs']);
